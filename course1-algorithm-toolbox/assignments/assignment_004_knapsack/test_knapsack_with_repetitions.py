...
from knapsack_with_repetitions import optimal_value

class KnapsackWithRepetitionTestCase(unittest.TestCase):
    ...
    def test_with_capacity_as_13_and_several_weights(self):
        ...
        values = [ 9, 16, 14, 30 ]
        value, items = optimal_value(capacity, weights, values)
        self.assertEqual(62, value)
        self.assertEqual([ 0, 0, 2, 3 ], items)
        self.assert_items_within_capacity(capacity, weights, values,
            value, items)
