...
class GraphUtil:
    ...
    def reaches(self, graph, x, y):
        """
        Given a graph and two distinct vertices u and v, checks if
...
class Solver:
    """
    Given an undirected graph and two distinct vertices u and v, checks if
    there is a path between u and v.
    """
    ...
    def solve(self):
        ...
        self._output(1 if GraphUtil().reaches(graph, x, y) else 0)
