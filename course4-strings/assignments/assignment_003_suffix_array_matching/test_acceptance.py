...
class AcceptanceTestCase(unittest.TestCase):
    ...
    def assert_result(self, expected_result):
        expected_items = expected_result.split()
    ...
    def test(self):
        ...
        for i in range(1, len(files) // 2 + 1):
            ...
            try:
                ...
                self.assert_result(answer_text)
...
class AcceptanceWithBinarySearchTestCase(AcceptanceTestCase):

    def setUp(self):
        super(AcceptanceWithBinarySearchTestCase, self).setUp()
...
if __name__ == '__main__':
    class_names = [
                      AcceptanceWithBinarySearchTestCase,
                  ]
